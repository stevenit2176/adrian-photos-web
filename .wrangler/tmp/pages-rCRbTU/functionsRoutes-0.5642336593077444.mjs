import { onRequestGet as __api_fulfillment_orders__id__ts_onRequestGet } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\fulfillment\\orders\\[id].ts"
import { onRequestDelete as __api_categories__id__delete_ts_onRequestDelete } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\categories\\[id]\\delete.ts"
import { onRequestPut as __api_categories__id__update_ts_onRequestPut } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\categories\\[id]\\update.ts"
...
import { onRequestGet as __api_analytics_stats_ts_onRequestGet } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\analytics\\stats.ts"
import { onRequestOptions as __api_analytics_stats_ts_onRequestOptions } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\analytics\\stats.ts"
...
import { onRequestPost as __api_categories_create_ts_onRequestPost } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\categories\\create.ts"
import { onRequestPost as __api_categories_upload_image_ts_onRequestPost } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\categories\\upload-image.ts"
import { onRequestPost as __api_fulfillment_calculate_ts_onRequestPost } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\fulfillment\\calculate.ts"
import { onRequestGet as __api_fulfillment_items_ts_onRequestGet } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\fulfillment\\items.ts"
import { onRequestGet as __api_fulfillment_orders_ts_onRequestGet } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\fulfillment\\orders.ts"
import { onRequestPost as __api_fulfillment_orders_ts_onRequestPost } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\fulfillment\\orders.ts"
...
import { onRequestPut as __api_photos__id__ts_onRequestPut } from "C:\\GitHub\\adrian-photos-web\\functions\\api\\photos\\[id].ts"
...
export const routes = [
    {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_fulfillment_orders__id__ts_onRequestGet],
    },
  {
      ...
      method: "DELETE",
      middlewares: [],
      modules: [__api_categories__id__delete_ts_onRequestDelete],
    },
  {
      ...
      method: "PUT",
      middlewares: [],
      modules: [__api_categories__id__update_ts_onRequestPut],
    },
  {
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_analytics_stats_ts_onRequestGet],
    },
  {
      routePath: "/api/analytics/stats",
      mountPath: "/api/analytics",
      method: "OPTIONS",
      middlewares: [],
      modules: [__api_analytics_stats_ts_onRequestOptions],
    },
  {
    ...
    },
  {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_categories_create_ts_onRequestPost],
    },
  {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_categories_upload_image_ts_onRequestPost],
    },
  {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_fulfillment_calculate_ts_onRequestPost],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_fulfillment_items_ts_onRequestGet],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_fulfillment_orders_ts_onRequestGet],
    },
  {
      routePath: "/api/fulfillment/orders",
      mountPath: "/api/fulfillment",
      method: "POST",
      middlewares: [],
      modules: [__api_fulfillment_orders_ts_onRequestPost],
    },
  {
    ...
    },
  {
      ...
      method: "PUT",
      middlewares: [],
      modules: [__api_photos__id__ts_onRequestPut],
    },
  {
