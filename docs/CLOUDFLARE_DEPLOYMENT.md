...
This is a comprehensive deployment guide for the Adrian Photos e-commerce platform. For a quick deployment of just the frontend, see [DEPLOY.md](DEPLOY.md). For backend infrastructure setup (D1 database, R2 storage), see [SETUP.md](SETUP.md).
...
The frontend is now deployed, but you need to set up the backend for full functionality:

1. **Follow the backend setup guide**: [SETUP.md](SETUP.md)
   - Create D1 database
...
3. **Test the API**: Use [TEST_AUTH_API.md](TEST_AUTH_API.md) to verify endpoints

## Additional Resources

- **Quick Deploy**: [DEPLOY.md](DEPLOY.md) - Fast deployment checklist
- **Backend Setup**: [SETUP.md](SETUP.md) - D1, R2, environment configuration
- **Architecture**: [architecture/](architecture/) - Technical documentation
- **Full Spec**: [SPEC.md](SPEC.md) - Complete technical specification
